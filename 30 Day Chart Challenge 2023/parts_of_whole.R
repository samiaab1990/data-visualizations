...
main_plot<-ggplot()+
geom_textbox(aes(x=7.5,y=12.8, label="Common Therapeutic Classes of Authorized Drugs in Europe Over the Years"), family="Space Mono", size=15, fontface="bold", box.color=NA, fill=NA, width=unit(1,"npc"), lineheight=0, color="#494949")+
...
ylim(c(0,13))+
theme_void()+
theme(plot.background = element_rect(fil="#FFFFFF"))+
...
ggsave(filename = "drug_development_part_of_whole.png", 
       plot=complete_plot, 
       width= 5 * 3, 
       height=13, 
       dpi=300,
